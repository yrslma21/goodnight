...
function showMessage(response) {
    if (response === "No") {
        ...
        if(noClickCount <= 5){
            ...
            questionElement.textContent =  "Okay Bubs, sorry for insisting so much. Of course I respect your boundaries and I'm sorry if I was being too pushy. I hope you have a fantastic dream tonight! And don't forget to love me a lot💕"
    ...
    if (response === "Yes") {
        ...
        yesMessage.textContent = "YESSSSS, see you in the morning!!";
